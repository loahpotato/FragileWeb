...
$(function(){
	...
	billCode.on("blur",function(){
		if(billCode.val() != null && billCode.val() != ""){
			...
			validateTip(billCode.next(),{"color":"red"},imgNo+" BillCode cannot be Null, please retype",false);
		}
	}).on("focus",function(){
		validateTip(billCode.next(),{"color":"#666666"},"* Please input BillCode",false);
	}).focus();
